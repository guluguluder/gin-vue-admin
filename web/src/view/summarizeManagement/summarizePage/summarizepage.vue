  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="用户名(学号)" min-width="100" prop="stuNumber" />
        <el-table-column align="left" label="昵称(姓名)" min-width="100" prop="stuName" />
        <el-table-column align="left" label="性别" min-width="60" prop="stuSex" />
        ...
        <el-table-column align="left" label="就业总结" min-width="100" prop="summary" />
        <el-table-column label="操作" min-width="250" fixed="right">
          <template #default="scope">
            <el-button type="primary" link icon="magic-stick" size="small" @click="openDetails(scope.row)">详情</el-button>
            <el-button type="primary" link icon="edit" size="small" @click="openEdit(scope.row)">填写总结</el-button>
    ...
    >
      <div style="height:auto;overflow:auto;padding:0 12px;">
        <el-form ref="userForm" :model="userInfo" label-width="80px">
          <el-form-item label="就业总结" prop="content">
            <el-input v-model="userInfo.summary" type="textarea" :rows="4" />
          </el-form-item>
        </el-form>
      </div>
      <template #footer>
    ...
    >
      <div style="height:60vh;overflow:auto;padding:0 12px;">
        <el-form ref="StudentForm" :rules="rules" :model="studentDetails" label-width="80px">
          ...
          <el-form-item label="就业总结" prop="summary">
            <el-input v-model="studentDetails.summary" type="textarea" :rows="4"/>
          </el-form-item>
        </el-form>
  ...
  userForm.value.validate(async valid => {
    if (valid) {
      ...
      if (dialogFlag.value === 'edit') {
        const res = await addSummary(req)
        if (res.code === 0) {
