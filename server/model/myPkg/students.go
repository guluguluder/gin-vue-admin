...
type Students struct {
	...
	GradeNumber string    `json:"grade_number" gorm:"grade_number" db:"grade_number"` // 学院
	StartTime   time.Time `json:"start_time" gorm:"start_time" db:"start_time"`       // 入学日期
	EndTime     time.Time `json:"end_time" gorm:"end_time" db:"end_time"`             // 毕业日期
